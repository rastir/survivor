...
namespace Test_Level1
{
    ...
    {
        /// <summary>
        /// Тесты для задания №7 Level1 "Курс 28 заданий"
        /// </summary>
        [TestMethod]
        public void Test1()
        {
            try
            {
                int[] data = new int[7] { 100, -50, 10, -25, 90, -35, 90 };
                int result = Level1.SumOfThe(7, data);
            ...
            {
                Console.WriteLine();
                Console.WriteLine("на вход --[7] { 100, -50, 10, -25, 90, -35, 90 }; ");
                Console.WriteLine("TEST 2 PASSED");
            }
        }
        ...
        public void Test2()
        {
            ...
            {
                Console.WriteLine();
                Console.WriteLine("на вход --[2] { 1, 1}; ");
                Console.WriteLine("TEST 2 PASSED");
            }
        }
        [TestMethod]
        public void Test3()
        {
            ...
            {
                Console.WriteLine();
                Console.WriteLine("на вход --[2] { 2, 2}; ");
                Console.WriteLine("TEST 2 PASSED");
            }
        }
        [TestMethod]
        public void Test4()
        {
            try
            {
                int[] data = new int[5] { 5, -25, 10, -35, -45 };
                int result = Level1.SumOfThe(7, data);
                Console.Write("искомое число" + result);
            }
            catch (IndexOutOfRangeException e)
            ...
            {
                Console.WriteLine();
                Console.WriteLine("на вход --[5] { 5, -25, 10, -35, -45 }; ");
                Console.WriteLine("TEST 2 PASSED");
            }
        }
    }
